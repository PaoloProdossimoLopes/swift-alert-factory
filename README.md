...
<!-- ACTIONS -->
## 🔎  ACTIONS
[![REPORT ISSUE](https://img.shields.io/badge/-⚠️_REPORT_ISSUE-grey?style=flat-square&logo=pull_request&logoColor=white)](https://github.com/PaoloProdossimoLopes/swift-alert-factory/issues)
[![PULL REQUEST](https://img.shields.io/badge/-⤴️_PULL_REQUEST-grey?style=flat-square&logo=pull_request&logoColor=white)](https://github.com/PaoloProdossimoLopes/swift-alert-factory/pulls)
...
```sh
git clone https://github.com/PaoloProdossimoLopes/swift-alert-factory.git
```
...
![GitHub](https://img.shields.io/github/license/PaoloProdossimoLopes/swift-alert-factory?color=black&style=flat-square)
